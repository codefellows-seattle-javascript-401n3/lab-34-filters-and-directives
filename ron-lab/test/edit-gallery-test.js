...
describe('Edit Gallery Component', function(){
  ...
  describe('testing typeof editGalleryCtrl()', () => {
    it('should be an object', () => {
      let editGalleryCtrl = this.$componentController('galleryItem', null);
      expect(typeof editGalleryCtrl).toEqual('object')
    });
  });

  describe('testing typeof editGalleryCtrl.updateGallery()', () => {
    it('should be a function', () => {
      let editGalleryCtrl = this.$componentController('galleryItem', null);
      expect(typeof editGalleryCtrl.deleteGallery).toEqual('function');
    });
  });
